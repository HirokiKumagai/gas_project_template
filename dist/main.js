...
(() => {
  ...
  var TaskManager = class {
    constructor(spreadsheetId, config2) {
      const spreadsheet = SpreadsheetApp.openById(spreadsheetId);
      this.sheet = spreadsheet.getSheetByName(config2.sheetName) || spreadsheet.insertSheet(config2.sheetName);
      this.config = config2;
      this.initializeSheet();
    }
    initializeSheet() {
      if (this.sheet.getLastRow() === 0) {
        this.sheet.getRange(1, 1, 1, this.config.headers.length).setValues([this.config.headers]);
      }
    }
    addTask(task) {
      const newTask = {
  ...
  function addNewTask2(title, dueDate, assignee) {
  ...
  function updateTaskStatus2(taskId, status) {
    if (!taskManager) initializeTaskManager();
    const success = taskManager.updateTaskStatus(taskId, status);
    return JSON.stringify({ success });
  }
  global.addNewTask = addNewTask2;
  global.getAllTasks = getAllTasks2;
  global.updateTaskStatus = updateTaskStatus2;

  // src/test.ts
  function assertEquals(expected, actual, message2) {
    if (JSON.stringify(expected) !== JSON.stringify(actual)) {
      throw new Error(`${message2}
\u671F\u5F85\u5024: ${JSON.stringify(expected)}
\u5B9F\u969B\u306E\u5024: ${JSON.stringify(actual)}`);
    }
    Logger.log(`\u2705 \u30C6\u30B9\u30C8\u6210\u529F: ${message2}`);
  }
  function runAllTests() {
    try {
      testAddNewTask();
      ...
      Logger.log("\u{1F389} \u5168\u3066\u306E\u30C6\u30B9\u30C8\u304C\u6210\u529F\u3057\u307E\u3057\u305F\uFF01");
    } catch (error) {
  ...
  function testGetAllTasks() {
    ...
    assertEquals(
      true,
      tasks.some((t) => t.id === task1.id),
      "\u30BF\u30B9\u30AF1\u304C\u53D6\u5F97\u3067\u304D\u308B\u3053\u3068"
    );
    assertEquals(
      true,
      tasks.some((t) => t.id === task2.id),
      "\u30BF\u30B9\u30AF2\u304C\u53D6\u5F97\u3067\u304D\u308B\u3053\u3068"
    );
  }
  function testUpdateTaskStatus() {
  ...
  // src/duplicate_test.ts
  function addNewTask3(title, dueDate, assignee) {
    return `Duplicate function called with: ${title}, ${dueDate}, ${assignee}`;
  }
  function testDuplicateFunction() {
    Logger.log("\u{1F50D} \u95A2\u6570\u540D\u306E\u7AF6\u5408\u30C6\u30B9\u30C8\u3092\u958B\u59CB\u3057\u307E\u3059...");
    try {
      Logger.log("1\uFE0F\u20E3 \u30ED\u30FC\u30AB\u30EB\u30B9\u30B3\u30FC\u30D7\u3067\u306E\u95A2\u6570\u5B9A\u7FA9\u3092\u30C6\u30B9\u30C8:");
      const localResult = addNewTask3("\u30ED\u30FC\u30AB\u30EB\u95A2\u6570\u30C6\u30B9\u30C8", "2024-03-25", "\u30C6\u30B9\u30C8\u30E6\u30FC\u30B6\u30FC");
      ...
      const globalResult = globalThis.addNewTask("\u30B0\u30ED\u30FC\u30D0\u30EB\u30C6\u30B9\u30C8", "2024-03-25", "\u30C6\u30B9\u30C8\u30E6\u30FC\u30B6\u30FC");
      ...
      Logger.log("\n3\uFE0F\u20E3 \u95A2\u6570\u306E\u53C2\u7167\u3092\u78BA\u8A8D:");
      const localFuncString = addNewTask3.toString();
      const globalFuncString = globalThis.addNewTask.toString();
      Logger.log("\u30ED\u30FC\u30AB\u30EB\u95A2\u6570\u306E\u5B9A\u7FA9:");
      Logger.log(localFuncString.slice(0, 100) + "...");
      Logger.log("\n\u30B0\u30ED\u30FC\u30D0\u30EB\u95A2\u6570\u306E\u5B9A\u7FA9:");
      Logger.log(globalFuncString.slice(0, 100) + "...");
      ...
      const globalFunctions = Object.keys(globalThis).filter(
  ...
  globalThis.testDuplicateFunction = testDuplicateFunction;
})();
